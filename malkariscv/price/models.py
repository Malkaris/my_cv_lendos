...
class PriceTable(models.Model):
    ...
    price_table_oldprice = models.CharField(max_length=200, verbose_name='Старая цена')
    price_table_newprice = models.CharField(max_length=200, verbose_name='Новая цена')
